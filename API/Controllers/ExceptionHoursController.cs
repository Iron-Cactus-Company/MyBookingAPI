...
namespace API.Controllers
{
    ...
    public class ExceptionHoursController : BaseApiController
    {
        ...
        public async Task<IActionResult> GetMany()
        {
            ...
            return HandleReadOneResponse<List<ExceptionHours>, List<ExceptionHoursResponseObject>>(result);
        }
        ...
        public async Task<IActionResult> Get(Guid id)
        {
            ...
            return HandleReadOneResponse<ExceptionHours, ExceptionHoursResponseObject>(result);
        }
